...
resource "azurerm_resource_group" "pwalleni-lab-ansible-rg" {
    name     = "pwalleni-lab-ansible-rg"
...
resource "azurerm_virtual_network" "vnet" {
    ...
    location            = "northeurope"
    resource_group_name = "${azurerm_resource_group.pwalleni-lab-ansible-rg.name}"
...
resource "random_id" "randomId" {
    keepers = {
        ...
        resource_group = "${azurerm_resource_group.pwalleni-lab-ansible-rg.name}"
    }
